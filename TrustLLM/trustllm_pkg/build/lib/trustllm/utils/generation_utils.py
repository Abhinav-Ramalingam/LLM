...
# Function to get backup_responses from the ERNIE API
...
# Function to generate backup_responses using OpenAI's API
...
# Function to generate backup_responses using Deepinfra's API
