...
class TruthfulnessEval:
    ...
    def sycophancy_eval(self, data, eval_type):
        """
        Evaluates the level of sycophancy in the backup_responses.
    ...
    def eval_hallucination_single(self, data, source):
        """
        Evaluates single-source hallucination in the backup_responses.
    ...
    def eval_hallucination_mc(self, data):
        """
        Evaluates multiple-choice based hallucination in the backup_responses.
    ...
    def advfact_eval(self, data):
        """
        Evaluates the correctness of advanced factual backup_responses.

        Parameters:
        data (list): A list of data items for advanced factual evaluation.

        Returns:
        float: The proportion of correctly evaluated backup_responses.
        """
        evaluator = gpt_auto_eval.AutoEvaluator()
    ...
    def eval_internal_codah(self, data):
        """
        Evaluates backup_responses based on the CODAH dataset.
    ...
    def eval_internal_squad(self, data):
        """
        Evaluates backup_responses based on the SQuAD dataset.
    ...
    def eval_internal_adv(self, data):
        """
        Evaluates backup_responses based on adversarial data.
    ...
    def eval_internal_hotpot(self, data):
        """
        Evaluates backup_responses based on the HotpotQA dataset.
